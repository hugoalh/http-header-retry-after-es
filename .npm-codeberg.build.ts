...
await transform({
	...
	metadata: {
		...
		homepage: "https://codeberg.org/hugoalh/http-header-retry-after-es#readme",
		bugs: {
			url: "https://codeberg.org/hugoalh/http-header-retry-after-es/issues"
		},
		license: "MIT",
		author: "hugoalh",
		repository: {
			type: "git",
			url: "git+https://codeberg.org/hugoalh/http-header-retry-after-es.git"
		},
		private: false,
		publishConfig: {
			access: "public"
